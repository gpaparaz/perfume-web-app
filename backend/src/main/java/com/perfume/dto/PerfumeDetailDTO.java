...
public class PerfumeDetailDTO {
    ...
    public static PerfumeDetailDTO from(Perfume p, List<PerfumeNote> notes, List<PerfumeAccord> accs) {
        ...
        for (PerfumeNote n : notes) {
            ...
            String layer = n.getLayer() == null ? "" : n.getLayer().toLowerCase();
            if (layer.equals("top"))
                d.top.add(nd);
            else if (layer.equals("heart"))
                d.heart.add(nd);
            else
                d.base.add(nd);
        }
    ...
    public List<NoteDTO> getTop() {
        return top;
    }

    public List<NoteDTO> getHeart() {
        return heart;
    }

    public List<NoteDTO> getBase() {
        return base;
    }

    public List<AccordDTO> getAccords() {
        return accords;
    }
    ...
    public static class AccordDTO {
        ...
        public AccordDTO(Long id, String name, Short rank) {
            this.id = id;
            this.name = name;
            this.rank = rank;
        }
