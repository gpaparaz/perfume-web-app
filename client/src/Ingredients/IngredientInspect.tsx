...
export default function IngredientInspect() {
  ...
  const exportCsv = () => {
    ...
    const row = [
      ...
      i.shortDescription,
      i.appearance,
      i.producingCountries,
      i.evolutionImmediate,
      i.evolutionAfterHours,
      i.evolutionAfterDays,
      i.fullExtractedText,
      i.sourceUrl,
      i.imageUrl,
      i.fromGlossary,
        ...
        <div className="card shadow-sm p-4">
          ...
          <div className="row">
            ...
            <div className="col-md-6">
              {tf("Sottocategoria", "subcategory")}
            </div>
            <div className="col-md-4">
              {tf("Volatilità tipica", "typicalVolatility")}
            </div>
            <div className="col-md-4">
              {tf("Intensità odore", "odorStrength")}
            </div>
            <div className="col-md-4">
              {tf("Nome botanico", "botanicalName")}
            </div>
          </div>
    ...
    <div className="container my-5">
      ...
      <div className="card shadow-sm p-4">
        ...
        <table className="table table-striped table-bordered mt-3">
          <tbody>
            <tr>
              <td>Nome botanico: {ingredient.botanicalName || "N/D"}</td>
            </tr>
            <tr>
              <td>Intensità odore: {ingredient.odorStrength || "N/D"}</td>
            </tr>
            <tr>
            ...
            <tr>
              <td>
                Paesi produttori: {ingredient.producingCountries || "N/D"}
              </td>
            </tr>
          </tbody>
        </table>
